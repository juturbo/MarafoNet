...
func (etcdService *EtcdService) PutNewGame(ctx context.Context, key string, jsonValue []byte) (bool, error) {
...
func (etcdService *EtcdService) PutIfUnmodified(ctx context.Context, key string, jsonValue []byte, lastRevision int64) (bool, error) {
	transaction := etcdService.client.Txn(ctx).
